...
<html lang="ko">
  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:40rem; border-radius:20px;">
		...
		<div class="card-body">
       	<br>
       	<span class="font-name" style="text-align:center; display:block;">${ requestScope['javax.servlet.error.message'] }</span><br><br>
       	<a href="${ contextPath }/main.do">
        	<button id="btn-Yes" class="btn btn-lg btn-primary btn-block" type="button">메 인 으 로</button>
      	</a><br>
      	<a href="javascript:history.back()">
        	<button id="btn-Yes" class="btn btn-lg btn-primary btn-block" type="button">이 전 페 이 지</button>
      	</a>
      	<br>
		</div>
	</div>
