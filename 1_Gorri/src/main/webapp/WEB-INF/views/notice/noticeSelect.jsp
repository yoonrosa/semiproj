			...
			<div class="admin-board">
			 	<div class="div1">
					...
					<c:if test="${ loginUser.isAdmin eq 'Y' }">
						<div style="float:right"><button class="kick" onclick="location.href='${contextPath}/boardWrite.no'">글 등록</button><button class="kick">삭제</button></div>
					</c:if>
					<br><br><br><br><%@include file="../common/searchNotice.jsp" %>
				</div>
			</div>
